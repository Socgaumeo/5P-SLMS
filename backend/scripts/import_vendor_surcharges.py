...
Sử dụng AI (Gemini) để parse dữ liệu từ Excel
"""
...
def main():
    ...
    try:
        if len(sys.argv) < 2:
            print("Usage: python import_vendor_surcharges.py <file_path> [vendor_name]")
            print("Example: python import_vendor_surcharges.py vendor_rates/Tam_bảo_092025.xlsx 'Tam Bảo'")
            sys.exit(1)
        
        file_path = sys.argv[1]
        # Mặc định là Tam Bảo nếu không cung cấp
